...
Method 1 -empty
```
ethans-mbp-3:docsearch ethanfang$ find technical//biomed -empty
```
```
ethans-mbp-3:docsearch ethanfang$ find technical//plos -empty
```
They both print out nothing as neither has any files that are empty. Its useful to help you find files that you have not started on yet.
[Link](https://man7.org/linux/man-pages/man1/find.1.html)

Method 2 -cmin (n)
```
ethans-mbp-3:docsearch ethanfang$ find technical//biomed -cmin 10
```
```
ethans-mbp-3:docsearch ethanfang$ find technical//plos -cmin 10
```
They both print out nothing as neither has any files that have been changed within the last 10 minutes. Its useful to help you find files that you have recently worked on an cannot remember the name of.
[Link](https://man7.org/linux/man-pages/man1/find.1.html)


Method 3 -links
```
ethans-mbp-3:docsearch ethanfang$ find technical//biomed -links 1
...
```
```
ethans-mbp-3:docsearch ethanfang$ find technical//plos -links 1
...
```
The first printed out every file with at least one link in biomed and the second printed out every file with at least one link in plos. It can help you find files that have links and you can choose the number of links. A link in this case associates a name with a file.
[Link](https://man7.org/linux/man-pages/man1/find.1.html)
